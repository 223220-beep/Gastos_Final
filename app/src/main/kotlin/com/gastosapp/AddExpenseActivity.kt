...
class AddExpenseActivity : AppCompatActivity() {
    ...
    private fun handleSave() {
        ...
        val expense = ExpenseEntity(
            ...
            userId = "user1" // Temporalmente fijo
        )
            ...
            speechRecognizer = SpeechRecognizer.createSpeechRecognizer(this).apply {
                setRecognitionListener(object : RecognitionListener {
                    override fun onReadyForSpeech(params: Bundle?) {
                        isListening = true
                        binding.btnMic.setColorFilter(ContextCompat.getColor(this@AddExpenseActivity, R.color.red_600))
                        Toast.makeText(this@AddExpenseActivity, "Escuchando...", Toast.LENGTH_SHORT).show()
                    }
                    ...
                    override fun onEndOfSpeech() {
                        isListening = false
                        binding.btnMic.setColorFilter(ContextCompat.getColor(this@AddExpenseActivity, R.color.gray_400))
                    }

                    override fun onError(error: Int) {
                        isListening = false
                        binding.btnMic.setColorFilter(ContextCompat.getColor(this@AddExpenseActivity, R.color.gray_400))
                        Toast.makeText(this@AddExpenseActivity, "Error en reconocimiento", Toast.LENGTH_SHORT).show()
                    }
